...
@section('title', 'Editar Tasa de Compra')
        ...
        <div class="container py-4">
            ...
            <form action="{{ url('purchase_rate/'.$purchase_rate->id) }}" method="post">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="value" id="value" value="{{ $purchase_rate->value }}" required />
                    </div>
                </div>
