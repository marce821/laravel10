...
@section('title', 'Editar de Responsables')
        ...
        <div class="container py-4">
            ...
            <form action="{{ url('responsible/'.$responsible->id) }}" method="post">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="num_doc" id="num_doc" value="{{ $responsible->num_doc }}"  />
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="name" id="name" value="{{ $responsible->name }}" required />
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nota" id="nota" value="{{ $responsible->nota }}"  />
                    </div>
                </div>
